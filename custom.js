...
$(window).on('load', function () {
    $('.loading-holder').addClass("notactive")
})
...
$(window).resize(function () {
    ...
    if ($(window).width() < 767) {
        $('.tree').removeClass('vertical');
        $('.tree').addClass('horizontal');
    } else {
        $('.tree').removeClass('horizontal');
        $('.tree').addClass('vertical');
    }
});
...
$("#flexCheckDefault").change(function () {
    $(".file-extra").toggleClass("notactive")
}).change();
...
jQuery("#calender-btn ").click(function () {
    jQuery("#calender-holder").toggle();
...
jQuery(".container").click(function () {
    jQuery("#calender-holder").css("display", "none");
});
